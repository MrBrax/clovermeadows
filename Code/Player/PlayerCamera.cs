...
public partial class PlayerCamera : Camera3D
{
	...
	public override void _Process(double delta)
	{
		...
		var minCameraPos = new Vector3( acreWidth * CurrentAcre.X + edgeBoundsX, 0, acreHeight * CurrentAcre.Y + edgeBoundsY );
		var maxCameraPos = new Vector3( acreWidth * CurrentAcre.X + acreWidth - edgeBoundsX, 0, acreHeight * CurrentAcre.Y + acreHeight - edgeBoundsY );
